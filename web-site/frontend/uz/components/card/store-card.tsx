    ...
    <div className="group z-30 cursor-pointer">
      <div className="-z-10">
        <div className="relative overflow-hidden p-2 rounded-lg bg-gray-100">
          ...
          />
          <Image
            className="w-20 absolute z-10 top-0 left-0"
            src="/logo.png"
            alt="logo"
            width={999}
            height={999}
          />
          {data.in_stock ? (
            <span className="bg-green-200 absolute bottom-0 left-0 flex w-full items-center font-bold text-black text-sm px-2 py-1 rounded">
              <svg
            ...
            <span className="bg-red-600 text-white absolute bottom-0 left-0 flex w-full items-center font-bold text-sm px-2 py-1 rounded">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
      ...
      <div className="flex items-center justify-between gap-x-2 mt-5">
        <button className="border hover:bg-gray-200 duration-300 py-2 rounded-lg px-2">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
